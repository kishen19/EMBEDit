...
def embed(dataset_name):
    ...
    # Small (110M), Fast, Non-gated, Top-tier performance
    ...
    # --- NO PROMPT NEEDED FOR BGE CLUSTERING ---
    # Unlike Gemma, BGE does not require a task instruction for clustering.
    # It works best on the raw text.
    ...
    # Mirroring your logic: 5 Processes on CPU
